...
<header>
    <a href="concesionario.html"><img class="logo" src="../Final/img/logo.png"></a>
...
<body>
    ...
    <form class="formulario" method="POST">
        ...
        <br><br><br>
        <button id="btnEnviar" class="botonsitocr7" type="submit" value="Buscar" name="submit">Agregar</button>
    </form>
    <div id="errores"></div>
    <br><br>
    <br><br>
